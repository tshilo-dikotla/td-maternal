...
from edc_lab.admin import (RequisitionAdminMixin, requisition_fieldset,
...
class MaternalRequisitionAdmin(CrfModelAdminMixin, RequisitionAdminMixin, admin.ModelAdmin):
