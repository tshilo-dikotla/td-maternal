    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_diabetic', models.CharField(choices=[
                 ('Yes', 'Yes'), ('No', 'No')], help_text='INELIGIBLE if YES', max_length=3, verbose_name='Are you diabetic?')),
                ('will_breastfeed', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='INELIGIBLE if NO',
                                                     max_length=3, verbose_name='Are you willing to breast-feed your child for 6 months?')),
                ('will_remain_onstudy', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='INELIGIBLE if NO',
                                                         max_length=3, verbose_name="Are you willing to remain in the study for the child's first three year of life")),
                ...
                ('will_get_arvs', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], help_text='If found POS by RAPID TEST. Then answer YES, can take them OFF STUDY at birth visit if there were not on therapy for atleast 4 weeks.',
                                                   max_length=15, null=True, verbose_name='(Interviewer) If HIV+ve, do records show that participant is taking, is prescribed,or will be prescribed ARVs (if newly diagnosed) during pregnancy?')),
                ...
                ('unenrolled', models.TextField(editable=False, max_length=350,
                                                null=True, verbose_name='Reason not enrolled')),
                ...
                ('last_period_date', models.DateField(blank=True, help_text='LMP', null=True, validators=[
                 edc_protocol.validators.date_not_before_study_start, edc_base.model_validators.date.date_not_future], verbose_name='What is the approximate date of the first day of the mother’s last menstrual period')),
                ('ga_lmp_enrollment_wks', models.IntegerField(
                    blank=True, help_text=' (weeks of gestation at enrollment, LMP). Eligible if >16 and <36 weeks GA', null=True, verbose_name='GA by LMP at enrollment.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(validators=[
                 edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report date')),
                ('antenatal_visits', models.CharField(choices=[
                 ('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='Are you ready to start the antenatal enrollment visits?')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(db_index=True, default='', editable=False,
                                          help_text='a field used for quick search', max_length=250, null=True)),
                ('screening_identifier', models.CharField(editable=False,
                                                          max_length=36, unique=True, verbose_name='Eligibility Identifier')),
                ...
                ('has_omang', models.CharField(choices=[
                 ('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='Do you have an OMANG?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_version', models.CharField(
                    editable=False, max_length=10, null=True)),
                ('consent_datetime', models.DateTimeField(help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.",
                                                          validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Consent date and time')),
                ('consent_reviewed', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='If No the participant is not eligible.', max_length=3, null=True, validators=[
                 edc_consent.validators.eligible_if_yes], verbose_name='I have explained the purpose of the specimen consent to the participant.')),
                ('assessment_score', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3, null=True, validators=[
                 edc_consent.validators.eligible_if_yes], verbose_name='To the best of my  knowledge, the client understands the purpose, procedures, risks and benefits of the specimen consent:')),
                ('consent_copy', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('Declined', 'Yes, but subject declined copy')], help_text='If participant declined the copy, return the copy to the clinic to be filed with the original specimen consent',
                                                  max_length=20, null=True, verbose_name='I offered the participant a copy of the signed specimen consent and the participant accepted the copy:')),
                ('site', models.ForeignKey(editable=False, null=True,
                                           on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maternal_visit', models.OneToOneField(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalVisit')),
                ('site', models.ForeignKey(editable=False, null=True,
                                           on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bpd', models.DecimalField(decimal_places=2, help_text='Units in cm.', max_digits=6,
                                            validators=[td_maternal.validators.validate_bpd], verbose_name='BPD?')),
                ('hc', models.DecimalField(decimal_places=2, help_text='Units in cm.', max_digits=6,
                                           validators=[td_maternal.validators.validate_hc], verbose_name='HC?')),
                ('ac', models.DecimalField(decimal_places=2, help_text='Units in cm.', max_digits=6,
                                           validators=[td_maternal.validators.validate_ac], verbose_name='AC?')),
                ('fl', models.DecimalField(decimal_places=2, help_text='Units in cm.', max_digits=6,
                                           validators=[td_maternal.validators.validate_fl], verbose_name='FL?')),
                ...
                ('ga_by_ultrasound_wks', models.IntegerField(help_text='Units in weeks.', validators=[
                 td_maternal.validators.validate_ga_by_ultrasound], verbose_name='GA by ultrasound in weeks')),
                ('ga_by_ultrasound_days', models.IntegerField(
                    help_text='must be less than 7days.', verbose_name='GA by ultrasound days offset')),
                ('est_fetal_weight', models.DecimalField(decimal_places=2, help_text='Units in grams.', max_digits=8,
                                                         validators=[td_maternal.validators.validate_fetal_weight], verbose_name='Estimated fetal weight')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marijuana_prior_preg', models.CharField(choices=[
                 ('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='Has the participant ever used marijuana prior to this pregnancy?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.",
                                                         validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date')),
                ('smoked_during_pregnancy', models.CharField(choices=[
                ...
                ('marijuana_during_preg', models.CharField(choices=[
                 ('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='Has the participant ever used marijuana during this pregnancy?')),
                ('marijuana_during_preg_freq', models.CharField(blank=True, choices=[('daily', 'Daily'), ('once every few days', 'Once every few days'), ('weekly', 'Weekly'), (
                    '2-3 times per month or less', '2-3 times per month or less')], max_length=30, null=True, verbose_name='If yes, please indicate how much: ')),
                ('other_illicit_substances_during_preg', models.TextField(blank=True, max_length=500, null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.",
                                                         validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date')),
                ('seen_at_clinic', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('DWTA', "Don't want to answer")], max_length=15,
                                                    verbose_name='At the last visit, you had asked to be referred to the Sexual Reproductive Health Clinic.  Have you been seen in that clinic since your last visit with us?')),
                ('reason_unseen_clinic', models.CharField(blank=True, choices=[('not_tried', 'I have not yet sought the clinic'), ('no_booking', 'I went to the clinic but could not get a booking'), ('in_confinement', 'I am observing confinement'), ('not_sexually_active', 'I am not sexually active right now'), (
                    'no_contraception_bf', 'I do not need contraception because I am breastfeeding'), ('too_far', 'The clinic is too far from my home'), ('partner_refused', 'My partner does not want me to attend'), ('mother_refused', 'My mother does not want me to attend'), ('OTHER', 'Other')], max_length=45, null=True, verbose_name='If no, why not?')),
                ('reason_unseen_clinic_other', edc_base.model_fields.custom_fields.OtherCharField(
                    blank=True, max_length=35, null=True, verbose_name='If Other, describe')),
                ('is_contraceptive_initiated', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No'), (
                    'DWTA', "Don't want to answer")], max_length=15, null=True, verbose_name='If you did attend, did you initiate a contraceptive method?')),
                ('contr_other', edc_base.model_fields.custom_fields.OtherCharField(blank=True, max_length=35,
                                                                                   null=True, verbose_name='If Other enter text description of other contraceptive method being used')),
                ('reason_not_initiated', models.CharField(blank=True, choices=[('no_options', 'There was not an option I preferred'), ('no_stock_for_preference', 'The option I preferred was out of stock (state option if this answer is indicated)'), ('not_sexually_active', 'I am not currently sexually active'), ('disrespected', 'I felt disrespected by the SRH clinic'), ('no_contraception_bf', 'I was told that because I am breastfeeding, I do not need a contraceptive metod'), (
                    'partner_refused', 'My current partner does not want me to use a contraceptive method'), ('was not attended by a clinician', 'I was not attended by a clinician when I went to the SRH clinic'), ('OTHER', 'Other')], max_length=45, null=True, verbose_name='If you have not initiated a contraceptive method after attending a SRH clinic, please share with use the reason why you have not initiated a method')),
                ('reason_not_initiated_other', edc_base.model_fields.custom_fields.OtherCharField(
                    blank=True, max_length=35, null=True, verbose_name='If other is selected enter text')),
                ('contr', models.ManyToManyField(blank=True, help_text='Tell us all that apply',
                                                 to='td_maternal.Contraceptives', verbose_name='If yes, which method did you select? ')),
                ('maternal_visit', models.OneToOneField(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalVisit')),
                ('site', models.ForeignKey(editable=False, null=True,
                                           on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.",
                                                         validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date')),
                ('new_diagnoses', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=25,
                                                   verbose_name="Have there been any new diagnoses or medical problems in the mother's health since last visit?")),
                ('diagnoses_other', edc_base.model_fields.custom_fields.OtherCharField(
                ...
                ('hospitalized', models.CharField(choices=[
                 ('Yes', 'Yes'), ('No', 'No')], max_length=25, verbose_name='Has the mother been hospitalized since the last study visit?')),
                ('hospitalization_reason_other', edc_base.model_fields.custom_fields.OtherCharField(
                    blank=True, max_length=35, null=True, verbose_name='if other specify...')),
                ('hospitalization_days', models.IntegerField(blank=True, null=True, validators=[
                 django.core.validators.MinValueValidator(1)], verbose_name='How many days was the mother hospitalized?')),
                ('diagnoses', models.ManyToManyField(blank=True, to='td_maternal.MaternalDiagnosesList',
                                                     verbose_name='Have any of the following diagnoses occured since last visit?')),
                ('hospitalization_reason', models.ManyToManyField(blank=True, to='td_maternal.MaternalHospitalization',
                                                                  verbose_name='Was the hospitalization for any of the following reasons?')),
                ('maternal_visit', models.OneToOneField(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalVisit')),
                ('site', models.ForeignKey(editable=False, null=True,
                                           on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
                ('who', models.ManyToManyField(to='td_maternal.WcsDxAdult',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.",
                                                         validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date')),
                ('laugh', models.CharField(choices=[('As much as I always could', 'As much as I always could'), ('Not quite so much now', 'Not quite so much now'), ('Definitely not so much now',
                                                                                                                                                                     'Definitely not so much now'), ('Not at all', 'Not at all')], max_length=75, verbose_name='In the past 7 days, I have been able to laugh and see the funny side of things?')),
                ('enjoyment', models.CharField(choices=[('As much as I ever did', 'As much as I ever did'), ('Rather less than I used to', 'Rather less than I used to'), (
                    'Definitely less than I used to', 'Definitely less than I used to'), ('Hardly at all', 'Hardly at all')], max_length=75, verbose_name='In the past 7 days, I looked forward with enjoyment of things?')),
                ('blame', models.CharField(choices=[('Yes, most of the time', 'Yes, most of the time'), ('Yes, some of the time', 'Yes, some of the time'), (
                    'Not very often', 'Not very often'), ('No, never', 'No, never')], max_length=75, verbose_name='In the past 7 days, I have blamed myself unnecessarily when things went wrong')),
                ('anxious', models.CharField(choices=[('No, not at all', 'No, not at all'), ('Hardly ever', 'Hardly ever'), ('Yes, sometimes', 'Yes, sometimes'), (
                    'Yes, very often', 'Yes, very often')], max_length=75, verbose_name='In the past 7 days, I have anxious or worried for no good reason')),
                ('panick', models.CharField(choices=[('Yes, quite a lot', 'Yes, quite a lot'), ('Yes, sometimes', 'Yes, sometimes'), ('No, not much', 'No, not much'), (
                    'No, not at all', 'No, not at all')], max_length=75, verbose_name='In the past 7 days, I have felt scared or panicky for no good reason')),
                ('top', models.CharField(choices=[("Yes, most of the time I haven't been able to cope at all", "Yes, most of the time I haven't been able to cope at all"), ("Yes, sometimes I haven't been coping as well as usual", "Yes, sometimes I haven't been coping as well as usual"), (
                    'No, most of the time I have coped quite well', 'No, most of the time I have coped quite well'), ('No, I have been coping as well as ever', 'No, I have been coping as well as ever')], max_length=75, verbose_name='In the past 7 days, things have been getting on top of me')),
                ('unhappy', models.CharField(choices=[('Yes, most of the time', 'Yes, most of the time'), ('Yes, some of the time', 'Yes, some of the time'), (
                    'Not very often', 'Not very often'), ('No, never', 'No, never')], max_length=75, verbose_name='In the past 7 days, I have been so unhappy that I have had difficulty sleeping')),
                ('sad', models.CharField(choices=[('Yes, most of the time', 'Yes, most of the time'), ('Yes, some of the time', 'Yes, some of the time'), (
                    'Not very often', 'Not very often'), ('No, never', 'No, never')], max_length=75, verbose_name='In the past 7 days, I have felt sad or miserable')),
                ('crying', models.CharField(choices=[('Yes, most of the time', 'Yes, most of the time'), ('Yes, quite often', 'Yes, quite often'), (
                    'Only occasionally', 'Only occasionally'), ('No, never', 'No, never')], max_length=75, verbose_name='In the past 7 days, I have been so unhappy that I have been crying')),
                ('self_harm', models.CharField(choices=[('Yes, quite often', 'Yes, quite often'), ('Sometimes', 'Sometimes'), ('Hardly ever', 'Hardly ever'), (
                    'Never', 'Never')], max_length=75, verbose_name='In the past 7 days, the thought of harming myself has occured to me')),
                ('total_score', models.IntegerField(blank=True,
                                                    default='', null=True, verbose_name='Total score')),
                ('maternal_visit', models.OneToOneField(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalVisit')),
                ('site', models.ForeignKey(editable=False, null=True,
                                           on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prev_pregnancies', models.IntegerField(validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(
                    20)], verbose_name='Including this pregnancy, how many previous pregnancies for this participant?')),
                ...
                ('live_children', models.IntegerField(validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(
                    20)], verbose_name='How many other living children does the participant currently have (excluding baby to be enrolled in the study)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.",
                                                         validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date')),
                ('chronic_since', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=25,
                ...
                ('who_diagnosis', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')], help_text='Please use the WHO Staging Guidelines. ONLY for HIV infected mothers',
                                                   max_length=25, verbose_name='Prior to the current pregnancy, was the participant ever diagnosed with a WHO Stage III or IV illness?')),
                ('mother_chronic_other', edc_base.model_fields.custom_fields.OtherCharField(
                    blank=True, max_length=35, null=True, verbose_name='if other, specify.')),
                ('father_chronic_other', edc_base.model_fields.custom_fields.OtherCharField(
                    blank=True, max_length=35, null=True, verbose_name='if other, specify.')),
                ('mother_medications_other', edc_base.model_fields.custom_fields.OtherCharField(
                    blank=True, max_length=35, null=True, verbose_name='if other, specify.')),
                ('sero_posetive', models.CharField(choices=[
                 ('Yes', 'Yes'), ('No', 'No')], max_length=25, verbose_name='Is the mother HIV sero-positive?')),
                ('date_hiv_diagnosis', models.DateField(blank=True, help_text='EDD Confirmed. Derived variable, see AntenatalEnrollment.', null=True, validators=[
                 edc_base.model_validators.date.date_not_future], verbose_name='If HIV sero-posetive, what is the approximate date of diagnosis?')),
                ('perinataly_infected', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), (
                    'N/A', 'Not applicable')], max_length=25, verbose_name='Was the mother peri-nataly infected with HIV?')),
                ('know_hiv_status', models.CharField(choices=[('Nobody', 'Nobody'), ('1 person', '1 person'), ('2-5 people', '2-5 people'), ('6-10 people', '6-10 people'), (
                    'More than 10 people', 'More than 10 people'), ('dont know', 'I do not know'), ('N/A', 'Not applicable')], max_length=50, verbose_name='How many people know that you are HIV infected?')),
                ('lowest_cd4_known', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), (
                    'N/A', 'Not applicable')], max_length=4, verbose_name="Is the mother's lowest CD4 known?")),
                ('cd4_count', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(
                    1)], verbose_name="What was the mother's lowest known (nadir) CD4 cell count(cells/mm3) at any time in the past?")),
                ('cd4_date', models.DateField(blank=True, help_text='Format is YYYY-MM-DD. Use 01 for Day', null=True,
                                              validators=[edc_base.model_validators.date.date_not_future], verbose_name='Year/Month of CD4 test ')),
                ('is_date_estimated', models.CharField(blank=True, choices=[('No', 'No'), ('Yes, estimated the Day', 'Yes, estimated the Day'), ('Yes, estimated Month and Day', 'Yes, estimated Month and Day'), (
                    'Yes, estimated Year, Month and Day', 'Yes, estimated Year, Month and Day')], max_length=50, null=True, verbose_name="Is the subject's date of CD4 test estimated?")),
                ('comment', models.TextField(blank=True,
                                             max_length=250, null=True, verbose_name='Comments')),
                ('father_chronic', models.ManyToManyField(related_name='father', to='td_maternal.ChronicConditions',
                                                          verbose_name="Does the father of the infant or the mother's other children have any of the above. Tick all that apply")),
                ('maternal_visit', models.OneToOneField(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalVisit')),
                ('mother_chronic', models.ManyToManyField(related_name='mother', to='td_maternal.ChronicConditions',
                                                          verbose_name='Does the mother have any of the above. Tick all that apply')),
                ('mother_medications', models.ManyToManyField(blank=True, to='td_maternal.MaternalMedications',
                                                              verbose_name='Does the mother currently take any of the above medications. Tick all that apply')),
                ('site', models.ForeignKey(editable=False, null=True,
                                           on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
                ('who', models.ManyToManyField(to='td_maternal.WcsDxAdult',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('may_call', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=25,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.",
                                                         validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date')),
                ('prev_preg_azt', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')],
                                                   max_length=25, verbose_name='Did she ever receive AZT monotherapy in a previous pregnancy?  ')),
                ('prev_sdnvp_labour', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')],
                                                       max_length=25, verbose_name='Did she ever receive single-dose NVP in labour during a previous pregnancy?')),
                ('prev_preg_haart', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('N/A', 'Not applicable')],
                                                     max_length=25, verbose_name='Did she ever receive triple antiretrovirals during a prior pregnancy?')),
                ('haart_start_date', models.DateField(blank=True, null=True, validators=[
                 edc_base.model_validators.date.date_not_future], verbose_name='Date of triple antiretrovirals first started')),
                ('is_date_estimated', edc_base.model_fields.date_estimated.IsDateEstimatedField(choices=[('-', 'No'), ('D', 'Yes, estimated the Day'), ('MD', 'Yes, estimated Month and Day'), (
                    'YMD', 'Yes, estimated Year, Month and Day')], help_text='If the exact date is not known, please indicate which part of the date is estimated.', max_length=25, verbose_name="Is the subject's date of triple antiretrovirals estimated?")),
                ('preg_on_haart', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=25,
                                                   verbose_name='Was she still on triple antiretrovirals at the time she became pregnant for this pregnancy? ')),
                ('haart_changes', models.IntegerField(help_text='If there was no change please enter 0.', validators=[
                ...
                ('prior_preg', models.CharField(choices=[('continuous', 'Received continuous HAART from the time she started'), ('restarted', 'Had treatment interruption but restarted HAART prior to this pregnancy'), (
                    'stopped', 'Had treatment interruption and never restarted HAART prior to this pregnancy'), ('N/A', 'Not Applicable')], max_length=80, verbose_name='Prior to this pregnancy the mother has ')),
                ('prior_arv_other', edc_base.model_fields.custom_fields.OtherCharField(
                    blank=True, max_length=35, null=True, verbose_name='if other specify...')),
                ('maternal_visit', models.OneToOneField(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalVisit')),
                ('prior_arv', models.ManyToManyField(to='td_maternal.PriorArv',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_complications', models.ManyToManyField(help_text="If 'OTHER', specify below",
                                                                  to='td_maternal.DeliveryComplications', verbose_name='Were any of the following complications present at delivery? ')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('money_earned_other', edc_base.model_fields.custom_fields.OtherCharField(
                    blank=True, max_length=35, null=True, verbose_name='if other specify...')),
                ('own_phone', models.CharField(choices=[
                 ('Yes', 'Yes'), ('No', 'No')], max_length=25, verbose_name='Do you have your own cell phone that you use regularly?')),
                ('water_source', models.CharField(choices=[('Piped directly into the house', 'Piped directly into the house'), ('Tap in the yard', 'Tap in the yard'), ('Communal standpipe', 'Communal standpipe'), (
                    'OTHER', 'Other water source (stream, borehole, rainwater, etc)')], help_text='the home where you are likely to spend the most time with your baby over the first 18 months', max_length=50, verbose_name="At your primary home  where do you get most of your family's drinking water?")),
                ('house_electrified', models.CharField(choices=[
                 ('Yes', 'Yes'), ('No', 'No')], max_length=25, verbose_name='Is there electricity in this house / compound? ')),
                ('house_fridge', models.CharField(choices=[
                 ('Yes', 'Yes'), ('No', 'No')], max_length=25, verbose_name='Is there a refrigerator being used in this house / compound?  ')),
                ('cooking_method', models.CharField(choices=[('Gas or electric stove', 'Gas or electric stove'), ('Paraffin stove', 'Paraffin stove'), ('Wood-burning stove or open fire', 'Wood-burning stove or open fire'), (
                    'No regular means of heating', 'No regular means of heating')], max_length=50, verbose_name='What is the primary method of cooking in this house / compound?')),
                ('toilet_facility', models.CharField(choices=[('Indoor toilet', 'Indoor toilet'), ('Private latrine for your house/compound', 'Private latrine for your house/compound'), ('Shared latrine with other compounds', 'Shared latrine with other compounds'), (
                    'No latrine facilities', 'No latrine facilities'), ('OTHER', 'Other, specify')], max_length=50, verbose_name='Which of the following types of toilet facilities do you most often use at this house / compound? ')),
                ('toilet_facility_other', edc_base.model_fields.custom_fields.OtherCharField(
                    blank=True, max_length=35, null=True, verbose_name='if other specify...')),
                ('house_people_number', models.IntegerField(validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(
                    100)], verbose_name='How many people, including yourself, stay in this home / compound most of the time?')),
                ('house_type', models.CharField(choices=[('Formal:Tin-roofed, concrete walls', 'Formal: Tin-roofed, concrete walls'), ('Informal: Mud-walled or thatched', 'Informal: Mud-walled or thatched'), (
                    'Mixed formal/informal', 'Mixed formal/informal'), ('Shack/Mokhukhu', 'Shack/Mokhukhu')], help_text='Indicate the primary type of housing used over the past 30 days', max_length=50, verbose_name='Housing type?  ')),
                ('maternal_visit', models.OneToOneField(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalVisit')),
                ('site', models.ForeignKey(editable=False, null=True,
                                           on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.",
                                                         validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date')),
                ('more_children', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('Dont know right now', 'I do not know right now'), ('DWTA', "Don't want to answer")],
                                                   help_text='If the answer to this question is "YES" continue to the next question else skip to question 6.', max_length=25, verbose_name='Do you desire more children?')),
                ('next_child', models.CharField(blank=True, choices=[('within 2years', 'Within the next 2 years'), ('between 2-5years from now', 'From 2 years to 5 years from now'), ('More than 5years from now',
                                                                                                                                                                                       'More than 5 years from now'), ('Dont know right now', 'I do not know right now'), ('DWTA', "Don't want to answer")], max_length=35, null=True, verbose_name='When would you like to have your next child?')),
                ('contraceptive_partner', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('no_partner', 'I do not currently have a partner'), (
                    'DWTA', "Don't want to answer")], max_length=10, verbose_name='Have you discussed a contraceptive method with your current partner?')),
                ('contraceptive_relative_other', edc_base.model_fields.custom_fields.OtherCharField(blank=True, help_text="If 'Other' is selected above, please type in the person or persons (by description only and not by name) with whom you have discussed your contraceptive method",
                                                                                                    max_length=35, null=True, verbose_name='If Other enter text description of other please give other people you discussed with')),
                ...
                ('influential_decision_making_other', edc_base.model_fields.custom_fields.OtherCharField(
                    blank=True, max_length=35, null=True, verbose_name='If another person was most influential, please give details below.')),
                ('uses_contraceptive', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), (
                    'DWTA', "Don't want to answer")], max_length=35, verbose_name='Are you currently using a contraceptive method?')),
                ('contraceptive_startdate', models.DateField(blank=True, null=True, validators=[
                 edc_base.model_validators.date.date_not_future], verbose_name='If yes, what date after delivery did you start using this contraceptive method?')),
                ('contr_other', edc_base.model_fields.custom_fields.OtherCharField(blank=True, max_length=35,
                                                                                   null=True, verbose_name='If Other enter text description of other contraceptive method being used')),
                ('another_pregnancy', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), (
                    'DWTA', "Don't want to answer")], max_length=35, verbose_name='Have you become pregnant since you last delivered?')),
                ('pregnancy_date', models.DateField(blank=True, null=True, validators=[
                 edc_base.model_validators.date.date_not_future], verbose_name='If yes, around what date did you find out?')),
                ('pap_smear', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('never_had_pap_smear', 'I have never had a Pap smear'), (
                    'DWTA', "Don't want to answer")], max_length=35, verbose_name='Do you know the date of your last Pap smear?')),
                ('pap_smear_date', models.DateField(blank=True, null=True, validators=[
                 edc_base.model_validators.date.date_not_future], verbose_name='Please provide the date of your last Pap smear.')),
                ('pap_smear_estimate', models.CharField(blank=True, choices=[('within_last_6months', 'Within the last 6 months'), ('more_than_6months_within_1year', 'More than 6 months ago but within the last year'), ('more_than_1year_within_2years', 'More than one year ago but within the last two years'), (
                    'more_than_1year_within_5years', 'More than one year ago but within the last five years'), ('more_than_5years', 'More than five years ago')], max_length=60, null=True, verbose_name='If you dont know that date of your last Pap Smear, is it possible that your last Pap smear was:')),
                ('pap_smear_result', models.CharField(blank=True, choices=[('Yes', 'Yes'), ('No', 'No'), (
                    'DWTA', "Don't want to answer")], max_length=20, null=True, verbose_name='Do you know the result of your last Pap smear')),
                ('pap_smear_result_status', models.CharField(blank=True, choices=[('normal', 'Normal'), ('abnormal', 'Abnormal'), (
                    'DWTA', "Don't Want to Answer")], max_length=30, null=True, verbose_name='The results of my Pap smear were: ')),
                ('pap_smear_result_abnormal', models.TextField(blank=True, max_length=50, null=True,
                                                               verbose_name='If the results of the Pap Smear were abnormal, can you please share the results with us: ')),
                ('date_notified', models.DateField(blank=True, null=True, validators=[
                 edc_base.model_validators.date.date_not_future], verbose_name='When were you notified of these results?')),
                ('srh_referral', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('DWTA', "Don't want to answer")],
                                                  max_length=25, verbose_name='Would you like to be referred to the Sexual Reproductive Health Clinic?')),
                ('contr', models.ManyToManyField(to='td_maternal.Contraceptives',
                                                 verbose_name='Please share with us your current contraceptive methods')),
                ('contraceptive_relative', models.ManyToManyField(to='td_maternal.MaternalRelatives',
                                                                  verbose_name='Have you discussed your contraceptive method with any of the following individuals? (Please select all that apply)')),
                ('maternal_visit', models.OneToOneField(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalVisit')),
                ('site', models.ForeignKey(editable=False, null=True,
                                           on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(default=django.utils.timezone.now, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.",
                                                         validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date')),
                ('contact_type', models.CharField(choices=[('voice_call', 'Voice Call'), ('text_message', 'Text Message'), (
                    'in_person', 'In person, e.g. Home visit')], max_length=25, verbose_name='Type of contact')),
                ('contact_datetime', models.DateTimeField(
                    help_text='This date can be modified.', verbose_name='Contact datetime')),
                ('call_reason', models.CharField(choices=[('follow_up', 'Follow up'), ('follow_up_pending_delivery', 'Follow up for pending delivery'), ('missed_visit_follow_up', 'Missed visit follow up'), ('scheduled_appointment', 'Confirm scheduled appointment'), (
                    'follow_up_delivery', 'Follow up on delivery status'), ('follow_up_labs', 'Follow up on abnormal labs'), ('nvp_2_week_adjustment', 'NVP 2 week dose adjustment'), ('OTHER', 'Other, specify')], max_length=30, verbose_name='Reason for call')),
                ...
                ('contact_success', models.CharField(choices=[
                 ('Yes', 'Yes'), ('No', 'No')], help_text='If Yes, please answer the next question.', max_length=5, verbose_name='Were you able to reach the participant?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight_kg', models.DecimalField(decimal_places=2, help_text='Measured in Kilograms (kg)', max_digits=5, validators=[
                 django.core.validators.MinValueValidator(30), django.core.validators.MaxValueValidator(136)], verbose_name="Mother's weight? ")),
                ('systolic_bp', models.IntegerField(help_text='in mm e.g. 120, should be between 75 and 220.', validators=[
                 django.core.validators.MinValueValidator(75), django.core.validators.MaxValueValidator(220)], verbose_name="Mother's systolic blood pressure?")),
                ('diastolic_bp', models.IntegerField(help_text='in hg e.g. 80, should be between 35 and 150.', validators=[
                 django.core.validators.MinValueValidator(35), django.core.validators.MaxValueValidator(150)], verbose_name="Mother's diastolic blood pressure?")),
                ('maternal_visit', models.OneToOneField(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalVisit')),
                ('site', models.ForeignKey(editable=False, null=True,
                                           on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('height', models.DecimalField(decimal_places=2, help_text='Measured in Centimeters (cm)', max_digits=5, validators=[
                 django.core.validators.MinValueValidator(114), django.core.validators.MaxValueValidator(195)], verbose_name="Mother's height? ")),
                ('maternal_visit', models.OneToOneField(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalVisit')),
                ('site', models.ForeignKey(editable=False, null=True,
                                           on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_interrupt', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.",
                                                         validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date')),
                ('missed_doses', models.IntegerField(validators=[django.core.validators.MinValueValidator(
                    0)], verbose_name='Since the last attended last scheduled visit, how many doses of triple ARVs were missed? ')),
                ('missed_days', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(
                    0)], verbose_name='Since the last attended scheduled visit, how many entire days were triple ARVS not taken?')),
                ('missed_days_discnt', models.IntegerField(default=0, validators=[django.core.validators.MinValueValidator(
                    0)], verbose_name='If triple ARVs discontinued by health provider, how many days were triple ARVs missed prior to discontinuation?')),
                ('comment', models.TextField(blank=True,
                                             max_length=250, null=True, verbose_name='Comment')),
                ('maternal_visit', models.OneToOneField(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalVisit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.",
                                                         validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date')),
                ('on_arv_since', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text="If 'NO' End. Otherwise continue go to section one",
                                                  max_length=25, verbose_name='Was the mother supposed to be on triple ARVs any time since the last attended scheduled visit?')),
                ('on_arv_reason', models.CharField(choices=[('maternal masa', 'HAART for maternal treatment (qualifies by Botswana guidelines)'), ('pmtct bf', 'HAART for PMTCT while breastfeeding'), (
                    'pp arv tail', 'Brief postpartum antiretroviral "tail"'), ('unsure', 'Unsure'), ('OTHER', 'OTHER'), ('N/A', 'Not applicable')], default='N/A', max_length=25, verbose_name='Reason for triple ARVs ')),
                ('on_arv_reason_other', models.TextField(blank=True,
                                                         max_length=35, null=True, verbose_name='if other, specify')),
                ('arv_status', models.CharField(choices=[('no_mod', '1. No modifications made since the last attended scheduled visit or today'), ('start', '2. Starting today or has started since last attended scheduled visit'), ('discontinued', '3. Permanently discontinued at or before the last attended scheduled visit'), (
                    'never started', '4. Never started'), ('modified', '5. Change in at least one medication since the last attended scheduled visit or today'), ('N/A', 'Not applicable')], default='N/A', max_length=25, verbose_name="What is the status of the participant's antiretroviral treatment / prophylaxis at this visit or since the last visit? ")),
                ('maternal_visit', models.OneToOneField(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalVisit')),
                ('site', models.ForeignKey(editable=False, null=True,
                                           on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_identifier', models.CharField(max_length=50,
                                                        unique=True, verbose_name='Subject Identifier')),
                ('screening_identifier', models.CharField(editable=False,
                                                          max_length=36, unique=True, verbose_name='Screening Identifier')),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text="If reporting today, use today's date/time, otherwise use the date/time this information was reported.",
                                                         validators=[edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date')),
                ('is_eligible', models.BooleanField(
                    default=False, editable=False)),
                ('infant_alive', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='If no then ineligible for study',
                                                  max_length=3, verbose_name='Has this woman given birth to a live born infant that has been enrolled in the Tshilo Dikotla ')),
                ('infant_weight', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='If no then ineligible for study',
                                                   max_length=3, verbose_name='Did the infant have a birth weight of ≥ 2.00 kilograms?')),
                ('major_anomalies', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='If yes then ineligible for study',
                                                     max_length=3, verbose_name='Was this infant born with any major congenital anomalies')),
                ('birth_complications', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='If yes then ineligible for study',
                                                         max_length=3, verbose_name='Did this infant experience any severe birth complications such as birth asphyxia or seizures?')),
                ('infant_documentation', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='If no then ineligible for study', max_length=3,
                                                          verbose_name='Does the infant have documentation that they received a BCG vaccine within 72 hours of birth in the Under 5 Health Booklet?')),
                ('infant_months', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='If yes then ineligible for study', max_length=3,
                                                   verbose_name='Has the infant reached 21 months of age or have they attended the 24 month Tshilo Dikotla Study visit?')),
                ('tb_treatment', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='If yes then ineligible for study', max_length=3,
                                                  verbose_name='Was this woman being treated for tuberculosis in pregnancy or at the time she delivered the infant enrolled in the Tshilo Dikotla Study?')),
                ('incarcerated', models.CharField(choices=[
                 ('Yes', 'Yes'), ('No', 'No')], help_text='If yes then ineligible for study', max_length=3, verbose_name='Is this woman currently incarcerated?')),
                ('willing_to_consent', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='If no then ineligible for study',
                                                        max_length=3, verbose_name='Is the woman willing to provide informed consent to participate in the Karabo study?')),
                ('ineligibility', models.TextField(editable=False,
                                                   max_length=150, null=True, verbose_name='Reason not eligible')),
                ('site', models.ForeignKey(editable=False, null=True,
                                           on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', django_crypto_fields.fields.firstname_field.FirstnameField(
                    blank=True, help_text='(Must match name on file with Tshilo Dikotla Study) (Encryption: RSA local)', max_length=71, verbose_name='First Name')),
                ('last_name', django_crypto_fields.fields.lastname_field.LastnameField(
                    blank=True, help_text='(Must match name on file with Tshilo Dikotla Study) (Encryption: RSA local)', max_length=71, verbose_name='Surname')),
                ('initials', django_crypto_fields.fields.encrypted_char_field.EncryptedCharField(
                    blank=True, help_text='(Must match initials on file with Tshilo Dikotla Study) (Encryption: RSA local)', max_length=71, verbose_name='Initials ')),
                ...
                ('language', models.CharField(choices=[
                 ('tn', 'Setswana'), ('en', 'English')], max_length=25, verbose_name='Language of consent:')),
                ('is_literate', models.CharField(choices=[
                 ('Yes', 'Yes'), ('No', 'No')], max_length=25, verbose_name='Is the participant literate?')),
                ('guardian_name', django_crypto_fields.fields.lastname_field.LastnameField(blank=True, help_text="Required only if participant is illiterate.<br>Format is 'LASTNAME, FIRSTNAME'. All uppercase separated by a comma. (Encryption: RSA local)",
                                                                                           max_length=71, null=True, validators=[edc_consent.validators.FullNameValidator()], verbose_name="Witness's last and first name")),
                ...
                ('identity', django_crypto_fields.fields.identity_field.IdentityField(
                    help_text='(must match Omang on file with Tshilo Dikotla Study) (Confirm that all Tshilo Dikotla women have enrolled with an Omang, otherwise will need additional ID questions.) (Encryption: RSA local)', max_length=71, verbose_name='Omang of consenting woman')),
                ('consent_reviewed', models.CharField(choices=[
                 ('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='I have reviewed the Karabo study consent with the client.')),
                ('study_questions', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3,
                                                     verbose_name='I have answered all questions the client had about the Karabo study consent.')),
                ('assessment_score', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3,
                                                      verbose_name='I have asked the client questions about the Karabo study and they have demonstrated an understanding of the study by their answers.')),
                ('consent_signature', models.CharField(choices=[
                 ('Yes', 'Yes'), ('No', 'No')], max_length=3, verbose_name='The client has signed the consent form.')),
                ('consent_copy', models.CharField(choices=[('Accepted', 'Yes and the client accepted the signed copy of the consent'), (
                    'Refused', 'Yes and the client refused the signed copy of the consent'), ('No', 'No')], max_length=25, verbose_name='I have offered the client a signed copy of the consent form.')),
                ('site', models.ForeignKey(editable=False, null=True,
                                           on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(db_index=True, default='', editable=False,
                                          help_text='a field used for quick search', max_length=250, null=True)),
                ('screening_identifier', models.CharField(db_index=True,
                                                          editable=False, max_length=36, verbose_name='Eligibility Identifier')),
                ('report_datetime', models.DateTimeField(default=edc_base.utils.get_utcnow, help_text='Date and time of assessing eligibility', validators=[
                 edc_protocol.validators.datetime_not_before_study_start, edc_base.model_validators.date.datetime_not_future], verbose_name='Report Date and Time')),
                ('age_in_years', models.IntegerField(
                    verbose_name='What is the age of the participant?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recruit_source', models.CharField(choices=[('ANC clinic staff', 'ANC clinic staff'), ('BHP recruiter/clinician', 'BHP recruiter/clinician'), (
                    'OTHER', 'Other, specify')], max_length=75, verbose_name='The mother first learned about the tshilo dikotla study from ')),
                ...
                ('recruitment_clinic', models.CharField(choices=[('PMH', 'Gaborone(PMH)'), ('G.West Clinic', 'G.West Clinic'), ('BH3 Clinic', 'BH3 Clinic'), ('Ext2', 'Extension 2 Clinic'), ('Nkoyaphiri', 'Nkoyaphiri Clinic'), (
                    'Lesirane', 'Lesirane Clinic'), ('Old Naledi', 'Old Naledi'), ('Mafitlhakgosi', 'Mafitlhakgosi'), ('OTHER', 'Other health facilities not associated with study site')], max_length=100, verbose_name='The mother was recruited from')),
                ('recruitment_clinic_other', models.CharField(blank=True, max_length=100,
                                                              null=True, verbose_name='if other recruitment clinic, specify...')),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(
                    max_length=100, null=True)),
                ('history_type', models.CharField(choices=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('maternal_visit', models.ForeignKey(blank=True, db_constraint=False, null=True,
                                                     on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='td_maternal.MaternalVisit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason_not_drawn', models.CharField(choices=[('N/A', 'Not applicable'), ('collection_failed', 'Tried, but unable to obtain sample from patient'), ('absent', 'Patient did not attend visit'), (
                    'refused', 'Patient refused'), ('no_supplies', 'No supplies'), ('other', 'Other')], default='N/A', max_length=25, verbose_name='If not drawn, please explain')),
                ('comments', models.TextField(blank=True, max_length=350, null=True)),
                ('maternal_visit', models.ForeignKey(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalVisit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rx', django_crypto_fields.fields.encrypted_char_field.EncryptedCharField(
                    blank=True, help_text=' (Encryption: RSA local)', max_length=71, verbose_name='Treatment Assignment')),
                ...
                ('dispensed', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default='No',
                                               help_text='To be confirmed by pharmacy staff only', max_length=10, verbose_name='Dispensed')),
                ('comment', models.TextField(
                    blank=True, help_text='Comment if any manual changes made to rando list', max_length=250, null=True)),
                ('delivery_clinic', models.CharField(choices=[('PMH', 'Gaborone(PMH)'), ('G.West Clinic', 'G.West Clinic'), ('BH3 Clinic', 'BH3 Clinic'), ('Lesirane', 'Lesirane Clinic'), ('Old Naledi', 'Old Naledi'), (
                    'Mafitlhakgosi', 'Mafitlhakgosi'), ('OTHER', 'Other health facilities not associated with study site')], max_length=100, verbose_name='Which clinic does the mother plan to deliver at?')),
                ('delivery_clinic_other', models.CharField(blank=True, max_length=100,
                                                           null=True, verbose_name='if other delivery clinic, specify...')),
                ('maternal_visit', models.OneToOneField(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalVisit')),
                ('site', models.ForeignKey(editable=False, null=True,
                                           on_delete=django.db.models.deletion.PROTECT, to='sites.Site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', edc_base.model_fields.uuid_auto_field.UUIDAutoField(blank=True, editable=False,
                                                                           help_text='System auto field. UUID primary key.', primary_key=True, serialize=False)),
                ('arv_code', models.CharField(choices=[('Nevirapine', 'NVP'), ('Kaletra', 'KAL'), ('Aluvia', 'ALU'), ('Truvada', 'TRV'), ('Emtricitabine', 'FTC'), ('Tenoforvir', 'TDF'), ('Zidovudine', 'AZT'), ('Lamivudine', '3TC'), ('Efavirenz', 'EFV'), ('Didanosine', 'DDI'), ('Stavudine', 'D4T'), ('Nelfinavir', 'NFV'), ('Abacavir', 'ABC'), (
                    'Combivir', 'CBV'), ('Ritonavir', 'RTV'), ('Trizivir', 'TZV'), ('Raltegravir', 'RAL'), ('Saquinavir,soft gel capsule', 'FOR'), ('Saquinavir,hard capsule', 'INV'), ('Kaletra or Aluvia', 'KAL or ALU'), ('Atripla', 'ATR'), ('Dolutegravir', 'DTG'), ('HAART,unknown', 'HAART,unknown')], max_length=25, verbose_name='ARV Code')),
                ...
                ('modification_date', models.DateField(validators=[
                 edc_base.model_validators.date.date_not_future], verbose_name='Date ARV Modified')),
                ...
                ('maternal_arv_post', models.ForeignKey(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalArvPost')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', edc_base.model_fields.uuid_auto_field.UUIDAutoField(blank=True, editable=False,
                                                                           help_text='System auto field. UUID primary key.', primary_key=True, serialize=False)),
                ('arv_code', models.CharField(choices=[('Abacavir', 'ABC'), ('Zidovudine', 'AZT'), ('Tenoforvir', 'TDF'), ('Lamivudine', '3TC'), ('Emtricitabine', 'FTC'), ('Nevirapine', 'NVP'), (
                    'Efavirenz', 'EFV'), ('Aluvia', 'ALU'), ('Dolutegravir', 'DTG'), ('HAART,unknown', 'HAART,unknown')], help_text='Regimen has to be at least 3.', max_length=35, verbose_name='ARV code')),
                ('start_date', models.DateField(help_text='WARNING: If date started is less than 4 weeks at delivery, complete off study.',
                                                null=True, validators=[edc_base.model_validators.date.date_not_future], verbose_name='Date Started')),
                ('stop_date', models.DateField(blank=True, null=True, validators=[
                 edc_base.model_validators.date.date_not_future], verbose_name='Date Stopped')),
                ('reason_for_stop', models.CharField(blank=True, choices=[('switch for tolerability', 'Switch for tolerability'), ('switch for drug outage', 'Switch for drug outage'), (
                    'Treatment failure', 'Treatment failure'), ('OTHER', 'Other, specify:')], help_text='If "Treatment Failure", notify study coordinator', max_length=50, null=True, verbose_name='Reason for stop')),
                ('reason_for_stop_other', models.TextField(blank=True,
                                                           max_length=250, null=True, verbose_name='Other, specify ')),
                ('maternal_arv_preg', models.ForeignKey(
                    on_delete=django.db.models.deletion.PROTECT, to='td_maternal.MaternalArvPreg')),
            ],
            options={
