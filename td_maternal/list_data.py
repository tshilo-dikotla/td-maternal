...
list_data = {
    ...
    'td_maternal.wcsdxadult': [
        ...
        ('persistent_generalized_lymphadeno', 'Persistent generalized lymphadeno'),
        ('unexplained_moderate_weight_loss', 'Unexplained moderate weight loss'),
        ...
        ('unexplained*_severe_weight_loss', 'Unexplained* severe weight loss'),
        ...
        ('stomatitis/gingivitis/periodontis', 'Stomatitis/gingivitis/periodontis'),
        ('anaemia/neutropaenia/thrombocytopa',
         'Anaemia/neutropaenia/thrombocytopa'),
        ('hiv_wasting_syndrome', 'HIV wasting syndrome'),
        ('pneumocystis_pneumonia', 'Pneumocystis pneumonia'),
        ('recurrent_severe_bacterial_pneumo', 'Recurrent severe bacterial pneumo'),
        ('chronic_herpes_simplex_infection', 'Chronic herpes simplex infection'),
        ...
        ('exp_cryptococcosis/meningitis', 'Exp cryptococcosis/meningitis'),
        ('diss_non-TB_mycobacterial_infection',
        ...
        ('sympt_nephropathy/cardiomyopathy', 'Sympt nephropathy/cardiomyopathy'),
        ('n/a', 'N/A')
    ],
}
